...
BASE_PATH="/home/orangepi/mjpg-streamer/mjpg-streamer-experimental"
export LD_LIBRARY_PATH="/home/orangepi/mjpg-streamer/mjpg-streamer-experimental"
#./mjpg_streamer -i "input_uvc.so --help"
#./mjpg_streamer -i "./input_uvc.so" -o "./output_http.so -w ./www"
#./mjpg_streamer -i "./input_uvc.so -n -f 30 -r 1280x960"  -o "./output_http.so -w ./www" 
$BASE_PATH/mjpg_streamer -i "$BASE_PATH/input_uvc.so -n -f 30 -r 640x480 -d /dev/video1"  -o "$BASE_PATH/output_http.so -w $BASE_PATH/www" &
